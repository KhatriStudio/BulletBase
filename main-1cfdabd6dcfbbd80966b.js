(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [179], {
        ...
        6409: function(e, t, r) {
            ...
            }, t.render = se, t.renderError = le, t.emitter = t.version = t.router = void 0, r(83619);
            var f = M(r(27378)),
                p = M(r(31542)),
                d = r(31410),
                h = M(r(87624)),
            ...
            var Q = b.getURL();
            (m.hasBasePath(Q) && (Q = m.delBasePath(Q)), j.scriptLoader) && (0, r(9499).initScriptLoader)(j.scriptLoader);
            var Y = new S.default(F, $),
                J = function(e) {
                    var t = s(e, 2),
                        r = t[0],
                        n = t[1];
                ...
                return (ue = C(n.mark((function e() {
                    ...
                    return n.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return s.length > 0 && void 0 !== s[0] ? s[0] : {}, r = I, e.prev = 3, e.next = 6, Y.routeLoader.whenEntrypoint("/_app");
                            case 6:
                            ...
                            case 9:
                                ...
                                break;
                            case 16:
                                return e.next = 18, Y.routeLoader.whenEntrypoint(N);
                            case 18:
                                e.t0 = e.sent;
                            case 19:
                                if (!("error" in (u = e.t0))) {
            ...
            function le(e) {
                var t = e.App,
                    n = e.err;
                return console.error(n), console.error("A client-side exception has occurred, see here for more info: https://nextjs.org/docs/messages/client-side-exception-occurred"), Y.loadPage("/_error").then((function(e) {
                    var t = e.page,
                        n = e.styleSheets;
                ...
                return o(e, [{
                    ...
                    value: function(e, t, r, n) {
                        var o = this,
                            ...
                            finalUrl = y ? g && m(g) : m(v);

                        // ✅ Log the final JSON URL
                        console.log("Data JSON URL:", finalUrl);
        ...
        98017: function(e, t, r) {
            ...
            var o, a = (o = r(27378)) && o.__esModule ? o : {
                    default: o
                },
                i = r(31542);
            t.Portal = function(e) {
        ...
        40400: function(e, t, r) {
            ...
            var n, o = (n = r(27378)) && n.__esModule ? n : {
                    default: n
                },
                a = r(39826)
        },
        45218: function(e, t, r) {
            "use strict";
            var n = r(93190),
                o = r(22972),
                a = r(27242),
        ...
        49572: function(e, t, r) {
            "use strict";
            var n;
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.AmpStateContext = void 0;
            var o = ((n = r(27378)) && n.__esModule ? n : {
                default: n
            }).default.createContext({});
            t.AmpStateContext = o
        },
        74489: function(e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
        ...
        85732: function(e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return !1
            }, t.addLocale = x, t.delLocale = w, t.hasBasePath = P, t.addBasePath = E, t.delBasePath = O, t.isLocalURL = k, t.interpolateAs = C, t.resolveHref = M, t.default = void 0;
            var c = r(3732),
                s = r(39169),
                l = r(7709),
                f = (r(87560), _(r(87624))),
                    ...
                    a(this, e), this.sdc = {}, this.sdr = {}, this._idx = 0, this.onPopState = function(e) {
                        ...
                        if (t) {
                            if (t.__N) {
                                ...
                                i._idx = u;
                                var s = h.parseRelativeUrl(n).pathname;
                ...
                return i(e, [{
                    ...
                    value: function() {
                        var t = o(n.mark((function t(r, o, a, i, u) {
                            var l, f, v, m, _, b, S, M, L, T, N, D, F, H, U, q, B, W, G, z, V, X, $, Q, Y, J, K, Z, ee, te, re, ne, oe, ae, ie, ue, ce, se;
                                ...
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 18:
                                        if (i._h || (this.isSsr = !1), p.ST && performance.mark("routeChange"), m = i.shallow, _ = {
                                                shallow: void 0 !== m && m
                                            }, this._inFlightRoute && this.abortComponentLoad(this._inFlightRoute, _), a = E(x(P(a) ? O(a) : a, i.locale, this.defaultLocale)), b = w(P(a) ? O(a) : a, this.locale), this._inFlightRoute = a, S = f !== this.locale, i._h || !this.onlyAHashChange(b) || S) {
                                            t.next = 35;
                                            break
                                        }
                                    ...
                                    case 35:
                                        return M = h.parseRelativeUrl(o), L = M.pathname, T = M.query, t.prev = 37, t.next = 40, this.pageLoader.getPageList();
                                    case 40:
                                    ...
                                    case 51:
                                        if (this.urlIsNew(b) || S || (r = "replaceState"), F = a, L = L ? c.removePathTrailingSlash(O(L)) : L, l && "/_error" !== L && (i._shouldResolveHref = !0, M.pathname = A(L, N), M.pathname !== L && (L = M.pathname, M.pathname = E(L), o = p.formatWithValidation(M))), H = c.removePathTrailingSlash(L), k(a)) {
                                            t.next = 61;
                                            break
                                        }
                                        t.next = 59;
                                    ...
                                    case 61:
                                        ...
                                        if (U = h.parseRelativeUrl(F), q = U.pathname, B = g.getRouteRegex(H), W = y.getRouteMatcher(B)(q), z = (G = H === q) ? C(H, q, T) : {}, W && (!G || z.result)) {
                                            t.next = 76;
                                            break
                                        }
                                    ...
                                    case 77:
                                        return e.events.emit("routeChangeStart", a, _), t.prev = 78, t.next = 81, this.getRouteInfo(H, L, T, a, F, _);
                                    case 81:
                                    ...
                                    case 93:
                                        if (this.isPreview = !!J.__N_PREVIEW, J.notFound !== I) {
                                            t.next = 107;
                                            break
                                        }
                                    ...
                                    case 104:
                                        return t.next = 106, this.getRouteInfo(ae, ae, T, a, F, {
                                            shallow: !1
                                        });
                                    case 106:
                                        $ = t.sent;
                                    case 107:
                                        return e.events.emit("beforeHistoryChange", a, _), this.changeState(r, o, a, i), i._h && "/_error" === L && 500 === (null === (v = self.__NEXT_DATA__.props) || void 0 === v || null === (X = v.pageProps) || void 0 === X ? void 0 : X.statusCode) && (null === J || void 0 === J ? void 0 : J.pageProps) && (J.pageProps.statusCode = 500), ie = i.shallow && this.route === H, ce = null !== (ue = i.scroll) && void 0 !== ue ? ue : !ie, se = ce ? {
                                            x: 0,
                                            y: 0
                                        } : null, t.next = 116, this.set(H, L, T, b, $, null !== u && void 0 !== u ? u : se).catch((function(e) {
                                    ...
                                    case 116:
                                        ...
                                        throw e.events.emit("routeChangeError", Y, b, _), Y;
                                    case 119:
        ...
        15156: function(e) {
            var t = function(e) {
                ...
                var b = Object.getPrototypeOf,
                    x = b && b(b(R([])));
                x && x !== r && n.call(x, a) && (_ = x);
                var w = g.prototype = m.prototype = Object.create(_);
